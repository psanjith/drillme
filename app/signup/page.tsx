    ...
    <div className="min-h-screen bg-[#0f1117] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Start preparing in under 3 minutes</p>
        </div>
        ...
        <div className="bg-[#1a1f2e] border border-[#2a3040] rounded-xl p-6">
          ...
          <Button variant="secondary" className="w-full" onClick={handleGoogleSignup} loading={googleLoading}>
